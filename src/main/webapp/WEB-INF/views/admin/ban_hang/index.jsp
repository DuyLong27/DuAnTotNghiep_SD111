        ...
        <div id="danhsachhoadon" class="container tab-pane fade"><br>
            <h2 class="text-primary">Danh Sách Hóa Đơn</h2>
                ...
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#choxacnhan">Chờ Xác Nhận</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#chogiao">Chờ Giao</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#dahuy">Đã Hủy</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#hoanthanh">Hoàn Thành</a>
                    </li>
                </ul>
...
<%--                    Hoa don cho giao--%>
                    <div id="chogiao" class="container tab-pane fade"><br>
                        <h3>Cho Giao</h3>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
                    </div>

<%--                    Hoa don hoan thanh--%>
                    <div id="hoanthanh" class="container tab-pane fade"><br>
                        <h3>Hoan Thanh</h3>
                        <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
                    </div>
