        ...
        <div class="col-md-9">
            ...
            <div class="row">
                <div class="col-3 mb-3">
                    <div class="border rounded-top-3 rounded-bottom-3">
                        <div class="ratio-4x3">
                            <img src="" class="mh-100 mw-100 rounded-top-3">
                        </div>
                        <div class="card-body text-center">
                            <h5 class="card-title">{{item.ten}}</h5>
                            <p class="card-text">{{item.giaBan}}</p>
                            <div class="bg-dark text-center rounded-bottom-3">
                                <a class="nav-link text-light" href="#">
                                    <i class="fa-solid fa-link"></i>Chi tiết đơn hàng</a>
                            </div>
                        </div>
                    </div>
                </div>
