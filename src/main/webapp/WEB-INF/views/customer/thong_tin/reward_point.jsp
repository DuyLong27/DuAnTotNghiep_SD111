...
<head>
    ...
    <style>
        ...
        .points-item {
            flex: 1;
            margin-right: 10px; /* khoảng cách giữa hai phần */
        }
        .points-item:last-child {
            margin-right: 0; /* không có khoảng cách cho phần cuối cùng */
        }
...
<div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-9">
            <h5><strong>Điểm thưởng của tôi</strong></h5>

            <div class="reward-card">
                <h5>Số Điểm Hiện Có: <span id="currentPoints">150</span></h5>
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#redeemModal">Đổi Mã Giảm Giá</button>
            </div>

            <div class="reward-card">
                <div class="points-container">
                    <div class="points-item">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEarnedPoints" aria-expanded="true" aria-controls="collapseEarnedPoints">
                            Điểm Đã Kiếm Được
                        </button>
                        <div id="collapseEarnedPoints" class="accordion-collapse collapse show" aria-labelledby="headingEarnedPoints">
                            <div class="accordion-body">
                                <ul>
                                    <li>Đơn hàng #001: 50 điểm</li>
                                    <li>Đơn hàng #002: 100 điểm</li>
                                    <li>Khuyến mãi: 10 điểm</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="points-item">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseUsedPoints" aria-expanded="false" aria-controls="collapseUsedPoints">
                            Điểm Đã Sử Dụng
                        </button>
                        <div id="collapseUsedPoints" class="accordion-collapse collapse" aria-labelledby="headingUsedPoints">
                            <div class="accordion-body">
                                <ul>
                                    <li>Đơn hàng #003: -30 điểm</li>
                                    <li>Đơn hàng #004: -50 điểm</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<!-- Modal Đổi Mã Giảm Giá -->
<div class="modal fade" id="redeemModal" tabindex="-1" aria-labelledby="redeemModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="redeemModalLabel">Đổi Mã Giảm Giá</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Nhập số điểm bạn muốn đổi để nhận mã giảm giá:</p>
                <input type="number" class="form-control" placeholder="Nhập số điểm" id="pointsToRedeem">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary">Đổi</button>
